          ...
          <div data-tina-field={tinaField(props, 'heading')}>
            <TinaMarkdown
              ...
              components={{
                ...
                h2: (p) => (
                  <h2
                    className="text-[26px] md:text-[32px] lg:text-[45px]  text-center mb-6"
                    {...p}
                  />
                ),
                h3: (p) => <h3 className="text-[16px] secondary-text mb-6" {...p} />,
                p: (p) => <p className="text-[16px] secondary-text mb-6" {...p} />,
              }}
            />
          </div>
        )}
