            ...
            <div className="pl-2">
                <div className="flex gap-x-4">
                    ...
                    <div className="flex flex-col">
                        ...
                        <h3 className="text-[20px]">{card.agency}</h3>
                    </div>
                </div>
                <div className="gap-y-3 flex flex-col ">
                    ...
                    <div className="flex gap-x-4">
                        <button className="bg-primary capitalize cursor-pointer text-[18px] px-4 py-2 w-auto rounded hover:opacity-80 text-white">{props.labelView}</button>
                        <button className="px-4 capitalize py-2 border text-[18px] primary-border rounded hover:text-white/80 transition-colors duration-300">{props.labelIntrested}</button>
                    </div>
                </div>
            </div>
        </div>
