...
function Activity({ props }) {
  ...
  // Derive activeLink from active state instead of using useEffect
  const activeLink =
    active === 'sheets' ? '/sheets' : active === 'statements' ? '/statements' : '/papers';
  ...
  const filteredCards = useMemo(() => {
    return allCards.filter((card) => {
      ...
      const matchesInterest =
        ...
        formData.interests.some((interest) => card.category.category === interest);
      // ---- Match by name ----
      const matchesName =
