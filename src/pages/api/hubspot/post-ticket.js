...
async function handler(req, res) {
  ...
  try {
    ...
    const { subject, description, amount, agency, program, vehicle, solicitationLink } =
      result.data;
    ...
    return res.status(500).json({ error: 'Failed to create or associate ticket in HubSpot' });
  }
}
